      ...
      <Container>
        ...
        <div className="my-8">
          <h2 className="text-3xl text-center md:text-left md:text-6xl">
            ...
            <br />
            Sharpen Your Interview Edge with AI
          </h2>

          <p className="mt-4 text-muted-foreground text-sm">
             Ace the interview. Get instant, AI-powered feedback to refine your technique and build unshakeable confidence.
             <br/> 
             Stop practicing—start succeeding.
          </p>
        </div>
